	...
	<div class="col-md-12">
		...
		<div class="submit-section">
			...
			<div class="row with-forms">
				...
				<div class="col-md-4">
					<h5>Bedrooms:</h5>
					<input class="search-field" type="text" name="bedrooms" value=""/>
				</div>
				<div class="col-md-4">
					<h5>Bathrooms:</h5>
					<input class="search-field" type="text" name="bathrooms" value=""/>
				</div>
				<div class="col-md-4">
					<h5>Belcony:</h5>
					<input class="search-field" type="text" name="belcony" value=""/>
				</div>
			</div>
			<!-- Row / End -->
			...
			<div class="row with-forms">
				...
				<div class="col-md-4">
					...
					<div class="select-input disabled-first-option">
						<input type="text" data-unit="BDT" name="price">
					</div>
				</div>
			</div>
			<!-- Row / End -->
		...
		<div class="input-group">
			<button class="button preview margin-top-5" type="submit" name="add_apartment" >Add Apartment <i class="fa fa-arrow-circle-right"></i></button>
		</div>
		<!-- Submit / End -->
